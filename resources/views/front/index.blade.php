                                ...
                                <div class="col-xl-12 col-lg-12">
                                    <div class="banner__img home-9 video-slider">
                                        <video class="w-100" style="width: 100%;height: 580px;" autoplay muted loop>
                                            <source src="{{asset('assets/front/img/slider/hooshcall2.mp4')}}" type="video/mp4">
                    ...
                    <div class="consulting-inner-wrap shine-animate-item">
                        <div class="consulting-content">
                            ...
                            <div class="content-right">
                                <h2 class="title">هوشکال را در شبکه های اجتماعی دنبال نمایید

                                </h2>
                                <p>
                                    شبکه‌های اجتماعی هوشکال سریع‌ترین روش دسترسی به اخبار هوش مصنوعی، تکنولوژی و فناوری است. اگر می‌خواهید به‌روز باشید، شبکه‌های اجتماعی هوشکال را دنبال کنید.
            ...
            <div class="row justify-content-center">
                <div class="col-xl-6">
                    <div class="section-title text-center mb-50 tg-heading-subheading animation-style3">
                        ...
                        <h2 class="title ">میتوانید مقالات روز را در اینجا بخوانید</h2>
                    </div>
                </div>
            </div>
            <div class="row justify-content-center">
                    ...
                    <div class="consulting-inner-wrap shine-animate-item">
                        <div class="consulting-content">
                            ...
                            <div class="content-right">
                                ...
                                <h2 class="title">برای عملی کردن آن، هوشکال همراه شماست !
                                </h2>
                                <p>
