                            ...
                            <form class="information" action="{{ route('back.settings.information.store') }}" role="form"
                                ...
                                <div class="row ">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group curve">
                                            <label> ایمیل 2 </label>
                                                <input name="info_email2" type="email" class="form-control"
                                                value="{{ old('info_email2', option('info_email2')) }}">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group curve">
                                            ...
                                            <input name="info_phone" type="text" class="form-control"
                                                value="{{ old('info_phone', option('info_phone')) }}">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group curve">
                                            ...
                                            <input name="info_phone2" type="text" class="form-control"
                                                value="{{ old('info_phone2', option('info_phone2')) }}">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group curve">
                                            <label> کد گوگل مپ </label>
                                            <textarea name="info_google_map" rows="4" class="form-control" placeholder="کد iframe گوگل مپ را اینجا قرار دهید">{{ old('info_google_map', option('info_google_map')) }}</textarea>
                                            <small class="form-text text-muted">کد iframe گوگل مپ را از سایت گوگل مپ کپی کرده و در این قسمت قرار دهید.</small>
                                        </div>
                                    </div>
