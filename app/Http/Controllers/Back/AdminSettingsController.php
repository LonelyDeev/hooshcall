...
class AdminSettingsController extends Controller
{
    ...
    public function information_store(Request $request)
    {
        $request->validate([
            ...
            'info_email2' => 'nullable|string|email|max:50',
            ...
            'info_nav_logo' => 'nullable|file|mimes:jpg,jpeg,png,webp,ico|max:2048',
            'info_address' => 'nullable|string|max:500',
            'info_phone' => 'nullable|string|max:20',
            'info_phone2' => 'nullable|string|max:20',
            'info_google_map' => 'nullable|string|max:1000',
        ]);
