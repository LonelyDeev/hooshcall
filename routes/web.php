...
Route::group(['as' => 'back.', 'prefix' => 'admin/', 'middleware' => ['auth']], function () {
    ...
    Route::get('contacts/{contact}/details', [AdminContactController::class, 'getDetails'])->name('contacts.details');
    Route::post('contacts/multipleDestroy', [AdminContactController::class, 'multipleDestroy'])->name('contacts.multipleDestroy');
